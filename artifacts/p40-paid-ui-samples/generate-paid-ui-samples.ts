...
const SPRING_TS_ROOT = path.resolve(REPO_ROOT, 'lib/spring-ts');
const NAMESPRING_DATA = path.resolve(REPO_ROOT, 'namespring/public/data');
...
import { SpringEngine } from '../../lib/spring-ts/src/index.js';
