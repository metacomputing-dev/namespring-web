...
export const SHINSAL_MEANINGS: Record<string, string> = {
  ...
  도화살: '사람을 끌어들이는 매력이 강해지는 기운이에요. 사람들과의 관계가 깊어져요.',
  ...
  형살: '서로를 다듬으며 긴장을 만드는 자리라, 규칙과 절차가 방패가 돼요.',
  해살: '은근히 어긋나기 쉬운 자리라, 오해가 쌓이기 전에 말로 풀면 가벼워져요.',
  파살: '맞물린 흐름이 어긋나기 쉬운 자리라, 마무리를 한 번 더 확인하면 좋아요.',
  천덕: '어려울 때 주변의 도움이 자연스럽게 모이는 기운이에요.',
  월덕: '너그러운 기운이 함께해 사람 사이의 마찰을 부드럽게 해요.',
  천월덕: '하늘과 달의 너그러운 기운이 함께 지켜 주는 자리예요.',
  상문살: '이별과 마무리의 정서가 스치는 자리라, 마음을 돌보는 시간이 필요해요.',
  조객살: '주변의 궂은일에 마음이 쓰이는 자리라, 위로를 주고받는 힘이 커져요.',
  복성귀인: '복이 스며드는 자리로, 어려움 속에서도 길이 열리는 기운이에요.',
  태극귀인: '큰 흐름의 보살핌을 받는 자리로 여겨지는 귀한 기운이에요.',
  학당귀인: '배움이 잘 스며드는 자리예요. 공부와 연구에서 빛나요.',
  협록: '곁에서 받쳐 주는 힘이 있어, 살림이 헐겁지 않은 자리예요.',
  록신: '제 몫의 녹이 놓인 자리예요. 일한 만큼 든든하게 돌아와요.',
  건록: '제 몫을 단단히 해내는 힘이 실린 자리예요.',
  덕수귀인: '덕이 물처럼 고이는 자리로, 베푼 만큼 되돌아오는 기운이에요.',
  금여귀인: '귀한 대접을 받는 기운이 실리는 자리예요.',
  백호: '강한 추진력이 실리는 자리라, 속도를 다듬으면 큰 힘이 돼요.',
  역마: '움직이고 옮겨 다니며 기회를 만드는 기운이에요.',
  도화: '사람을 끌어들이는 매력이 강해지는 기운이에요.',
  화개: '홀로 깊어지는 재능이 있어 몰입과 사색에서 빛이 나요.',
  공망: '비어 있는 자리를 채우려는 힘이 생겨, 준비를 한 번 더 하게 돼요.',
};

/** 힘이 되어 주는 쪽으로 읽는 신살(길신). 나머지는 완급 조절의 신호로 분류한다. */
export const SHINSAL_BENEFIC = new Set([
  '천덕귀인',
  '월덕귀인',
  '천을귀인',
  '문창귀인',
