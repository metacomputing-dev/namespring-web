...
function buildFrontendChecklist(coverage) {
  ...
  return {
    status: hardFailures.length === 0 ? 'ready_with_known_content_gaps' : 'blocked',
    docs,
    checks,
    nextFrontendSteps: [
...
function buildCommercialChecklist(coverage, authority) {
  const blockers = [];
...
function buildReport(options = {}) {
  ...
  return {
    ...
    commercialReadiness: buildCommercialChecklist(coverage, authority),
    metrics: {
