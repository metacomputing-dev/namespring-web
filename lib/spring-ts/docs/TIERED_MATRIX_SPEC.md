...
- fragment bundle: 255개
- narrative fragments: 2,726개 (`_seed` placeholder 165개 + authored 2,561개)
...
- source-tier baseline: fragments `T1_HYPOTHESIS` 2,726개, numericalEvidence `T3_INTERNAL_ENGINE` 110개, authority-truth eligible 0개
- axis-pair density baseline: tracked pair missing combination 0개, thin combination 0개 (`npm run ci:narrative-density`)
- axis-tuple density baseline: tracked tuple missing combination 163개, thin combination 0개 (`npm run ci:narrative-tuple-density`)
