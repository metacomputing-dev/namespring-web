...
- fragment bundle: 238개
- narrative fragments: 2,303개 (`_seed` placeholder 165개 + authored 2,138개)
...
- source-tier baseline: fragments `T1_HYPOTHESIS` 2,303개, numericalEvidence `T3_INTERNAL_ENGINE` 110개, authority-truth eligible 0개
