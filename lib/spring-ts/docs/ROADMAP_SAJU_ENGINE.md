...
| 10-3 pressure 합거 | ✅ 구현·기본 off | 0915087d8 → a9f27f52b | 2026-07-14 재검토 | 표본 480건에서 강약 level 18건·용신 10건 이동. authority holdout 및 Stack11 실효 성분 정합 전 production 사용 금지; `applyToPressure:true`는 실험용 명시 opt-in만 허용 |
| 10-4 성패 점수 통합 | ✅ 구현·기본 off | 893a3c0d4 → 13320a31c | 2026-07-14 재검토 | 월지 damage의 quality 감점과 verdict 감점 중복을 제거하고 음수 배율을 방어. 독립 승인 전 `seongpaeScore.enabled:true` opt-in만 허용 |
