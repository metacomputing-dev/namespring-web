...
>
> 현재 리뷰 단위: 누적 PR #653을 대체한 스택 PR #654~#678(25개). 20개는 Ready이고 #662·#665·#668·#671·#676 5개는 Draft다. 진행 상태는 §9 표에 커밋 해시와 함께 갱신한다.
>
> **2026-07-14 merge-readiness 정정:** Ready는 독립 리뷰 시작 상태이고 merge 승인이 아니다. exact-tip 결함이 없고 회귀·한계가 공개된 20개 PR은 Ready이며, 실제 코드·CI P1 또는 저장소 문서 정합이 남은 5개만 Draft다.
> 현재
...
|---|---|---|---|---|
| P0-1 스택 PR | 🟢 20개 Ready / 🔶 5개 Draft | PR #654~#678 | 2026-07-14 | 25개 base/head 스택을 병렬 재감사해 #662·#665·#668·#671·#676만 Draft로 유지했다. #662는 월지손상 이중감점·기반 감쇠 층위 P1, #665는 exact-tip CI Seed 설치 누락, #668은 좌표 coercion, #671은 품질 증거 내부 모순이 원인이다. 후자의 세 결함은 후속 스택에서 해소됐지만 해당 historical tip에는 남는다. #676은 코드 P1이 아니라 Ready/merge 저장소 문서 정합을 남긴다. Ready PR도 fingerprint·명리·Actions·authority/signoff 전 merge하지 않으며 frontend source diff는 0이다. |
...
| PR #653 리뷰 범위(역사 기록) | ✅ 25개 스택으로 대체·종료 | 6fb2f68a4 | 2026-07-12~14 | freeze `origin/main...6fb2f68a4`의 134커밋·418파일과 후속 backend 체크포인트를 커밋 재작성 없이 #654~#678에 배치했다. 현재 20개 Ready·5개 Draft이며 frontend source diff는 0이다. 누적 PR 자체는 닫혔다. |
