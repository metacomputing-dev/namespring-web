// Phase 37 Agent A1 -- candidate selection (post P36-A1 104-ID LIFTED set)
// Selects standard.fragments.json fragments still at 3p, with ct in 1..3,
// excluding all fragments touched by prior lift batches (104 IDs:
// 99 inherited from P36-A1 + 5 from P36-A1's new lifts).
...
// Fragments touched by prior P2x/P30/P31/P32/P33/P34/P35/P36 lifts, must be excluded.
const LIFTED = new Set([
  ...
  // P36-A1 (5, 3p->4p) -- new this phase to exclude
...
fs.writeFileSync(
  'artifacts/phase37-agent-a1/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
