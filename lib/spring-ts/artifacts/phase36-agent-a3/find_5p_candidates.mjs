/**
 * artifacts/phase36-agent-a3/find_5p_candidates.mjs
 *
 * P36-A3 — Walk every expert.fragments.json. For each 5-paragraph
 * fragment, count fire frequency across the sample fixtures.
 * Print top candidates by fire count.
 *
 * Adapted from artifacts/phase34-agent-a3/find_5p_candidates.mjs
 * (5p->6p target). Per task brief:
 *   "P28-A2/P30-A4/P32-A3/P33-A3/P34-A3 lift fragments 무수정"
 * — excluding 50 prior-lifted fragments (10 each phase) from candidates.
 */
...
// 50 fragments lifted by P28-A2 + P30-A4 + P32-A3 + P33-A3 + P34-A3. EXCLUDED.
