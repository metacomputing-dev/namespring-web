// Phase 39 Agent A2 -- candidate selection (post P38-A1 114-ID LIFTED set)
...
// 109 inherited from P37-A1 + 5 new from P38-A1 = 114 IDs.
...
const LIFTED = new Set([
  ...
  // P38-A1 (5, 3p->4p) -- new this phase to exclude
  'expression_children.thisYear.standard.40_54.006',
  'expression_children.today.standard.70plus.008',
  'health.life.standard.strong.001',
  'movement.life.standard.40_54.006',
  'movement.thisWeek.standard.70plus.008',
]);
...
fs.writeFileSync(
  'artifacts/phase39-agent-a2/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
