// Phase 32 Agent A2 -- candidate selection (post P25-A2/P26-A2/P26-A3/P27-A3/P29-A4/P30-A1/P31-A4)
...
// Fragments touched by prior P2x/P30/P31 lifts, must be excluded.
...
fs.writeFileSync(
  'artifacts/phase32-agent-a2/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
