// Phase 33 Agent A2 -- candidate selection (post P25-A2/P26-A2/P26-A3/P27-A3/P29-A4/P30-A1/P31-A4/P32-A2)
...
// Fragments touched by prior P2x/P30/P31/P32 lifts, must be excluded.
...
fs.writeFileSync(
  'artifacts/phase33-agent-a2/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
