// Phase 36 Agent A2 -- find 4p fragments in owned scope, with ct ∈ [1..3] in 4p cells
// Excludes fragments already lifted to 5p by P26-A3 / P27-A3 / P30-A1 / P34-A2 / P35-A3 (50 fragments).
// Goal: 5p band 290 → 300 (+10). Math: pick ct mix summing to exactly 10.
...
// P26-A3 (10) + P27-A3 (10) + P30-A1 (7) + P34-A2 (13) + P35-A3 (10) = 50 fragments
...
console.log('All ct=1 candidates with paragraph lengths:');
for (const c of candidates.filter((c) => c.ct === 1)) {
...
fs.writeFileSync(
  'artifacts/phase36-agent-a2/candidates-4p.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
