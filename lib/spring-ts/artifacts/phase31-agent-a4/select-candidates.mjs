// Phase 31 Agent A4 -- candidate selection (post P25-A2/P26-A2/P26-A3/P27-A3/P29-A4/P30-A1)
...
// Fragments touched by prior P2x/P30 lifts, must be excluded.
...
fs.writeFileSync(
  'artifacts/phase31-agent-a4/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
