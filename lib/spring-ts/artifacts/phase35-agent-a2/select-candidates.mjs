// Phase 35 Agent A2 -- candidate selection (post P34-A1 92-ID LIFTED set)
// Selects standard.fragments.json fragments still at 3p, with ct in 1..3,
// excluding all fragments touched by prior lift batches (92 IDs:
// 84 inherited + 8 from P34-A1).
...
// Fragments touched by prior P2x/P30/P31/P32/P33/P34 lifts, must be excluded.
const LIFTED = new Set([
  ...
  // P34-A1 (8, 3p->4p) -- new this phase to exclude
...
fs.writeFileSync(
  'artifacts/phase35-agent-a2/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
