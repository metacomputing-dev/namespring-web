// Phase 36 Agent A1 -- candidate selection (post P35-A2 99-ID LIFTED set)
// Selects standard.fragments.json fragments still at 3p, with ct in 1..3,
// excluding all fragments touched by prior lift batches (99 IDs:
// 92 inherited from P35-A2 + 7 from P35-A2's new lifts).
...
// Fragments touched by prior P2x/P30/P31/P32/P33/P34/P35 lifts, must be excluded.
const LIFTED = new Set([
  ...
  // P35-A2 (7, 3p->4p) -- new this phase to exclude
...
fs.writeFileSync(
  'artifacts/phase36-agent-a1/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
