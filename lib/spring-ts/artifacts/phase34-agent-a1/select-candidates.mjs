// Phase 34 Agent A1 -- candidate selection (post P25-A2/P26-A2/P26-A3/P27-A3/P29-A4/P30-A1/P31-A4/P32-A2/P33-A2)
// Selects standard.fragments.json fragments still at 3p, with ct in 1..3,
// excluding all fragments touched by prior lift batches (83 IDs).
...
// Fragments touched by prior P2x/P30/P31/P32/P33 lifts, must be excluded (83 IDs).
...
fs.writeFileSync(
  'artifacts/phase34-agent-a1/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
