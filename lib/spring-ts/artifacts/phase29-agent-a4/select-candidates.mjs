// Phase 29 Agent A4 -- candidate selection (post P25-A2/P26-A2/P27-A3)
// Selects standard.fragments.json fragments still at 3p, with ct in 1..3,
// excluding all fragments touched by P25-A2/P26-A2/P26-A3/P27-A3.
...
// Fragments touched by prior P2x lifts, must be excluded.
const LIFTED = new Set([
  ...
  // P26-A3 / P27-A3 (additional 4p->5p moves; already not 3p but exclude defensively)
...
fs.writeFileSync(
  'artifacts/phase29-agent-a4/candidates-ct1to3.json',
  JSON.stringify(
    candidates.map((c) => ({
      fragmentId: c.fid,
      ct: c.ct,
