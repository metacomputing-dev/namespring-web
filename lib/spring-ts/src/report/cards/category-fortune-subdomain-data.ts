...
> = {
  wealth: {
    high: '재물 흐름이 좋아 적극적인 운용도 안전한 시기예요.',
    mid: '재물은 무리 없이 안정적이에요. 큰 결정은 신중히 검토하세요.',
    low: '재물 영역은 보수적으로 운영하는 것이 좋아요.',
  },
  health: {
    high: '체력과 회복력이 안정적이라 큰 부담 없이 활동할 수 있어요.',
    mid: '건강은 평년 수준이에요. 식습관과 수면 관리를 일관되게 유지하세요.',
    low: '건강 영역은 무리 없는 일정을 짜고 불편한 신호가 있으면 혼자 버티지 말고 필요한 도움을 받으세요.',
  },
  academic: {
    high: '학습 효율과 집중도가 올라가 시험·문서 관련 일이 잘 풀려요.',
    mid: '학업은 평이한 시기예요. 정기 점검과 복습 위주의 운영이 좋아요.',
    low: '학업 영역은 욕심을 줄이고 기본 정리에 집중하면 결과가 안정돼요.',
  },
  romance: {
    high: '인연의 결이 부드러워지고 감정 표현이 자연스러워지는 시기예요.',
    mid: '관계는 무리 없는 거리감을 유지하면 큰 굴곡 없이 지나가요.',
    low: '관계 영역은 충돌을 최소화하고 본인 페이스를 지키는 것이 안전해요.',
  },
  family: {
    high: '가족 분위기가 따뜻해지고 의사소통이 자연스럽게 풀리는 시기예요.',
    mid: '가족 운은 안정적이에요. 이벤트보다 일상적인 돌봄이 의미 있어요.',
    low: '가족 영역은 큰 결정을 미루고 갈등 요인은 일찍 풀어두는 것이 좋아요.',
  },
  career: {
    high: '관성 흐름이 안정되어 직장·조직 내 평가가 좋아지는 시기예요.',
    mid: '직장운은 평이해요. 새로운 시도보다 안정적인 운영이 유리해요.',
    low: '조직 내 갈등 신호는 빠르게 정리하고 무리한 도전은 미루세요.',
  },
  study_document: {
  ...
  expression_children: {
    high: '식상이 활성화되어 표현·창작·자녀 관련 기운이 자연스럽게 받쳐 주는 시기예요.',
    mid: '표현 영역은 무리 없이 안정적이에요. 결과보다 과정에 집중하세요.',
    low: '표현·전달 영역은 단어 선택을 신중히 하고 중요한 결정은 한 번 더 검토하세요.',
  },
  health_stress: {
    high: '인성 + 조후 흐름이 안정적이라 생활 리듬을 회복하기 쉬운 시기예요.',
    mid: '스트레스 영역은 무리 없는 수준이에요. 충분한 수면을 확보하세요.',
    low: '스트레스 신호가 누적되기 쉬우니 일찍 휴식과 회복 시간을 확보하세요.',
  },
  movement: {
