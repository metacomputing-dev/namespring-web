...
import type { SajuSummary, SpringReport, NamingReport, SajuReport, BirthInfo } from '../types.js';
...
// ─────────────────────────────────────────────────────────────────────────────
//  7. Premium report aliases (backwards-compatible names for PR #31 sections)
// ─────────────────────────────────────────────────────────────────────────────

/** Premium report section (alias for ReportSection) */
export type PremiumReportSection = ReportSection;

/** Premium saju report (alias for IntegratedReport) */
export type PremiumSajuReport = IntegratedReport;

/** Premium section ID (alias for ReportSectionId) */
export type PremiumSectionId = ReportSectionId;
