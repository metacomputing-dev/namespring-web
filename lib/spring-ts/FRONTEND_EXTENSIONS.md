...
- **콘텐츠 풀**: 253개 fragment bundle / 2,646 narrative fragments (authored 2,481 + `_seed` placeholder 165) / 130 glossary entries.
...
- **Tuple-density status**: tracked 3축 조합은 missing 203개이며, `--min-authored=2` 기준 thin tuple combination은 0개.
