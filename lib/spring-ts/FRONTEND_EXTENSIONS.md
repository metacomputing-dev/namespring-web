...
- **콘텐츠 풀**: 252개 fragment bundle / 2,602 narrative fragments (authored 2,437 + `_seed` placeholder 165) / 130 glossary entries.
...
- **Tuple-density status**: tracked 3축 조합은 missing 225개이며, `--min-authored=2` 기준 thin tuple combination은 0개.
