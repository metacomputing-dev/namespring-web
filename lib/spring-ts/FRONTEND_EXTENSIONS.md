...
- **콘텐츠 풀**: 254개 fragment bundle / 2,686 narrative fragments (authored 2,521 + `_seed` placeholder 165) / 130 glossary entries.
...
- **Tuple-density status**: tracked 3축 조합은 missing 183개이며, `--min-authored=2` 기준 thin tuple combination은 0개.
