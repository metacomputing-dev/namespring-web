...
- **콘텐츠 풀**: 258개 fragment bundle / 3,052 narrative fragments (authored 2,887 + `_seed` placeholder 165) / 130 glossary entries.
...
- **Tuple-density status**: tracked 3축 조합은 missing 0개이며, `--min-authored=2` 기준 thin tuple combination은 0개.
