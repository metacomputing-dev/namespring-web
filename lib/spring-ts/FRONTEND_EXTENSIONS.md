...
- **콘텐츠 풀**: 240개 fragment bundle / 2,325 narrative fragments (authored 2,160 + `_seed` placeholder 165) / 130 glossary entries.
...
- **Pair-density status**: tracked axis-pair 조합은 missing 0개이며, `--min-authored=2` 기준 thin pair combination은 149개.
