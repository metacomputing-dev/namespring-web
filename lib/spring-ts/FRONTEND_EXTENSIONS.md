...
- **콘텐츠 풀**: 244개 fragment bundle / 2,373 narrative fragments (authored 2,208 + `_seed` placeholder 165) / 130 glossary entries.
...
- **Pair-density status**: tracked axis-pair 조합은 missing 0개이며, `--min-authored=2` 기준 thin pair combination은 89개.
