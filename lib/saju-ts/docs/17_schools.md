...
- [ ] **urgency 임계 0.55의 타당성**: 「調候為急」 발동 임계가 고전 사례(엄동·성하 명식)에서 실제로 조후 우선 전환을 일으키는지 표본 검증.
