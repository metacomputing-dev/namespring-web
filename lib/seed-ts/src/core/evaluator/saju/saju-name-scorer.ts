...
import { computeYongshinScore, type YongshinScoreResult } from "./yongshin-scorer.js";
...
export function resolveAdaptiveWeights(
  ...
  const shift =
    SAJU_WEIGHT_SHIFT_CONTRAST * contrast * (SAJU_WEIGHT_SHIFT_CONFIDENCE_BASE + SAJU_WEIGHT_SHIFT_CONFIDENCE_MULT * confidenceBoost) +
